...
;(function($, window, undefined)
{
	...
	$(document).ready(function()
	{
		...
		neonRegister.$container.validate({
			...
			{
				$(".login-page").addClass('registation in progress');
				...
				neonRegister.setPercentage(30, function()
				{
					...
					neonRegister.setPercentage(98, function()
					{
						...
						$.ajax({
							...
							url: 'http://localhost/nairabox/data/sample-register-form.php',
							method: 'POST',
							dataType: 'json',
							data: {
							...
							success: function(response)
							{
								...
								var name = response.submitted_data.name,
									...
									city = response.submitted_data.city,
