    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title">Add a New Parent</div>
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="/parents/create" method="post">
                    ...
                    <div class="form-group">
                        ...
                        @else
                            ...
                            <div class="col-sm-10">
                                <select name="student" class="select2" data-allow-clear="true" data-placeholder="Select a Student..." required>
                                    <option></option>
                                    @foreach($students as $student)
                                        <option value="{{$student->uid}}">{{$student->fname}} {{$student->middlename}}  {{$student->lname}}</option>
                                    @endforeach
                                </select>
