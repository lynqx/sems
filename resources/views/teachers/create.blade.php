...
@extends('layouts.main', ['page_title'=>'Register A New Teacher'])
@section('content')
    ...
    <div class="row">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title">Add a New Teacher</div>
            ...
            <div class="panel-body">
                ...
                <form role="form" class="form-horizontal form-groups-bordered" action="/teachers/create" method="post">
